...
from cakeapp.forms import RegistrationForm,LoginForm,CategoryCreateForm,CakeAddForm,CakeVarientForm,CakeOfferForm
...
class CakeUpdateView(UpdateView):
    ...
    def form_valid(self,form):
        messages.success(self.request,"cake  updated succesfully")
        return super().form_valid(form)
